                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div class="flex justify-between">
                            ...
                            <button type="submit" wire:loading.attr="disabled"
                                class="bg-amber-600 text-white px-8 py-3 rounded-xl font-bold text-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-all">
                                ...
                                <span wire:loading.remove wire:target="submit">Registrar Participación</span>
                                <span wire:loading wire:target="submit">Registrando...</span>
                            </button>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div class="flex flex-col md:flex-row justify-center gap-4 mt-8">
                            ...
                            <button type="button" wire:click="resendEmail" wire:loading.attr="disabled" wire:target="resendEmail"
                                class="bg-blue-700 hover:bg-blue-800 text-white px-8 py-3 rounded-xl font-bold text-sm shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-all">
                                <svg wire:loading wire:target="resendEmail" class="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                                <span wire:loading.remove wire:target="resendEmail">Volver a enviar correo</span>
                                <span wire:loading wire:target="resendEmail">Envío en proceso...</span>
                            </button>
                        </div>
                    </div>
                </section>
