    ...
    public function run(): void
    {
        ...
        for ($i = 0; $i < 10; $i++) {
            ...
            Survey::create([
                ...
                'height' => $height,
                'waist' => rand(70, 120),
                'daily_activity' => rand(0, 1) == 1 ? 'si' : 'no',
                'fruit_consumption' => rand(0, 1) == 1 ? 'si' : 'no',
                'antihypertensive_medication' => rand(0, 1) == 1 ? 'si' : 'no',
                'elevated_glucose' => rand(0, 1) == 1 ? 'si' : 'no',
                'family_history' => ['no', 'familiar grado 2', 'familiar grado 1'][rand(0, 2)],
                'bmi' => $bmi,
                'score' => $score,
                'risk_level' => $risk,
